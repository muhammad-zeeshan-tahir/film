		...
		sass: {
            ...
            dist: {
                ...
                files: [{
                    ...
                    'assets/css/high-contrast.css': 'assets/scss/high-contrast.scss', 	        /* 'All High Contrast SCSS'          */
        ...
        uglify: {
          my_target: {
            files: {
                ...
                'assets/bundles/vendorscripts.bundle.js': ['../assets/vendor/metisMenu/metisMenu.js','../assets/vendor/bootstrap-progressbar/js/bootstrap-progressbar.min.js','../assets/vendor/jquery-sparkline/js/jquery.sparkline.min.js'], /* coman js*/
